    ...
    elseif textItem:getText() == 'Clear' then
        ...
        if cursorIndexPath then
            ...
            if item then
                ...
                addon_message(207, '('..windower.ffxi.get_player().name..') '.."Alright, I'll figure out what to use on my own for Step "..indexPath.section.."!")
    ...
    elseif textItem:getText() == 'Skip' then
        ...
        if cursorIndexPath then
            ...
            if item then
                ...
                self.weaponSkillSettings:saveSettings(true)
                addon_message(207, '('..windower.ffxi.get_player().name..') '.."Alright, I'll let a party member take care of Step "..indexPath.section.."!")
