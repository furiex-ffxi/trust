...
return {
    Subjob = {
        ...
        Debuffs = L{
            ...
            Debuff.new("Addle", L{}, L{"WAR", "WHM", "RDM", "PLD", "BRD", "SAM", "DRG", "BLU", "PUP", "SCH", "RUN", "MNK", "BLM", "THF", "BST", "RNG", "NIN", "SMN", "COR", "DNC", "GEO", "DRK"}),
    ...
    Default = {
        PartyBuffs = L{
            Buff.new("Haste", L{}, L{"WAR", "WHM", "RDM", "PLD", "BRD", "SAM", "DRG", "BLU", "PUP", "SCH", "RUN", "MNK", "BLM", "THF", "BST", "NIN", "SMN", "DNC", "GEO", "DRK"}, nil, L{}),
            Buff.new("Flurry", L{}, L{"COR", "RNG"}, nil, L{}),
