...
return {
    ...
    Default = {
        ...
        GambitSettings = {
            Gambits = L{
                Gambit.new("Enemy", L{InBattleCondition.new()}, Spell.new("Horde Lullaby", L{}, L{}, nil, L{}), "Enemy"),
                Gambit.new("Enemy", L{InBattleCondition.new()}, Spell.new("Horde Lullaby II", L{}, L{}, nil, L{}), "Enemy"),
                Gambit.new("Enemy", L{InBattleCondition.new()}, Spell.new("Carnage Elegy", L{}, L{}, nil, L{}), "Enemy")
            }
        },
        PullSettings = {
            Abilities = L{
