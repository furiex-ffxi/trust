...
return {
    ...
    Default = {
        Skills = L{
            ...
            CombatSkillSettings.new("Sword", L{"Circle Blade", "Seraph Blade", "Sanguine Blade", "Vorpal Blade", "Red Lotus Blade", "Shining Blade", "Fast Blade", "Burning Blade", "Flat Blade"}, "Seraph Blade"),
