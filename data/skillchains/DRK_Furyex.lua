...
return {
    ...
    Default = {
        Skills = L{
            ...
            CombatSkillSettings.new("Scythe", L{"Spinning Scythe", "Cross Reaper", "Dark Harvest", "Guillotine", "Quietus", "Entropy", "Slice", "Shadow of Death", "Infernal Scythe", "Vorpal Scythe", "Nightmare Scythe"}, "Insurgency"),
