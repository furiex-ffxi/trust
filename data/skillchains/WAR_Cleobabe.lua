...
return {
    ...
    Default = {
        Skills = L{
            CombatSkillSettings.new("Great Axe", L{"Shield Break", "Iron Tempest", "Fell Cleave", "Weapon Break", "Keen Edge", "Sturmwind", "Raging Rush"}),
            ...
            CombatSkillSettings.new("Club", L{}, "Judgement"),
