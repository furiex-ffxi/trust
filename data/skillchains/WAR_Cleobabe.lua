...
return {
    ...
    Default = {
        Skills = L{
            ...
            CombatSkillSettings.new("Sword", L{"Burning Blade", "Circle Blade", "Fast Blade", "Vorpal Blade", "Flat Blade", "Shining Blade", "Seraph Blade", "Red Lotus Blade"}, "Burning Blade"),
